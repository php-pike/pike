...
class AuditConfiguration
{
    ...
    public function setRevisionDataType($toggle) {
        $this->revisionDataType = $toggle == 'new' ? $toggle : 'old';
    }

    public function getRevisionDataType() {
        return $this->revisionDataType;
    }
